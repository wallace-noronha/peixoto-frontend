                                                        ...
                                                        return (
                                                            <tr key={key}>
                                                                ...
                                                                <td className="text-right">
                                                                    <span  className="btn btn-simple btn-info btn-icon like"><i className="fa fa-heart"></i></span>
                                                                    <span className="btn btn-simple btn-warning btn-icon edit"><i className="fa fa-edit"></i></span>
                                                                    <span className="btn btn-simple btn-danger btn-icon remove"><i className="fa fa-times"></i></span>
                                                                </td>
                                                            </tr>
                                                        )
                                                    })
